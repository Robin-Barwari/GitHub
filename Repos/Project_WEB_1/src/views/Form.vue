...
<template>
    <div id="app">
        <form class="vue-form" @submit.prevent="submit">
            ...
            <fieldset>
                <legend>Register as a carry today</legend>
                <div>
                ...
                <div>
                    ...
                    <p class="select">
                        <select class="budget" v-model="selection.member">
                            <option value="0">CS:GO</option>
                            <option value="1">R6S</option>
                ...
                <div>
                    <label class="label" for="rank">Rank in-game</label>
                    <input type="text" name="rank" id="rank" required="" v-model="rank">
                </div>
                <div>
                    <label class="label" for="salary">Enter your salary: €</label>
                    <input type="number" id="salary" name="salary"
                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
                </div>

                <div>
                    <label class="number" for="textarea">Message to us</label>
